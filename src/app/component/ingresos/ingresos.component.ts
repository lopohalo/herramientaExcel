...
export class IngresosComponent implements OnInit {
  ...
  informacion = [
    ...
    },
    {
      ...
      CPC: '0',
      FUENTESDEFINANCIACION:
        'OTRAS TRANSFERENCIAS CORRIENTES DE OTRAS ENTIDADES CON DESTINACION ESPECIFICA LEGAL DEL GOBIERNO GENERAL ',
    ...
    },
    {
      ...
      CPC: '0',
      FUENTESDEFINANCIACION:
        'R.F. DE SISTEMA GENERAL DE SEGURIDAD SOCIAL EN SALUD - FONDOS ESPECIALES DEL MINISTERIO DE SALUD Y PROTECCION SOCIAL ',
      TERCEROS: 'NO APLICA ',
      POLITICAPUBLICA: 'NO APLICA ',
    },
    {
  ...
  modeloInformacion = [
    ...
    },
    {
      ...
      CONCEPTO: 'INGRESOS CORRIENTES DE LIBRE DESTINACION ',
    },
    {
    ...
    },
    {
      ...
      CONCEPTO:
        'Inscripciones - Pregrado a Distancia                                                                                                                                                                    ',
    },
    {
    ...
    },
    {
      ...
      CONCEPTO:
        'Derechos Académicos Pregrado Presencial                                                                                                                                                                 ',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.02.116.01.01.03.08',
      CONCEPTO:
        'Derechos Académicos Pregrado A Distancia                                                                                                                                                                ',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.02.116.01.01.04         ',
      CONCEPTO:
        'Certificaciones, Constancias Académicas y Derechos Complementarios                                                                                                                                      ',
    },
    {
    ...
    },
    {
      ...
      CONCEPTO:
        'Cursos Nivelación - Pregrado Presencial                                                                                                                                                                 ',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.02.116.01.01.04.06',
      CONCEPTO:
        'Cursos Nivelación - Pregrado A Distancia                                                                                                                                                                ',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.02.116.01.01.04.07',
      CONCEPTO:
        'Estudios de Transferencias -  Pregrado Presencial                                                                                                                                                       ',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.02.116.01.01.04.08',
      CONCEPTO:
        'Estudios de Transferencias -  Pregrado a Distancia                                                                                                                                                      ',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.02.116.01.01.04.09',
      CONCEPTO:
        'Cursos de Vacaciones - Pregrado Presencial                                                                                                                                                              ',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.02.116.01.01.04.10',
      CONCEPTO:
        'Cursos de Vacaciones - Pregrado a Distancia                                                                                                                                                            ',
    },
    {
    ...
    },
    {
      ...
      CONCEPTO:
        'Derechos De Grado - Especialización                                                                                                                                                             ',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.02.116.01.02.02.02      ',
      CONCEPTO:
        'Derechos De Grado - Maestría                                                                                                                                                                      ',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.02.116.01.02.02.03      ',
      CONCEPTO:
        'Derechos De Grado - Doctorado                                                                                                                                                                           ',
    },
    {
    ...
    },
    {
      ...
      CONCEPTO:
        'Productos Alimenticios, Bebidas y Tabaco, Textiles, Prendas de Vestir y Productos del Cuero',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.05.002.02.01            ',
      CONCEPTO:
        'Venta Productos Pecuarios                                                                                                                                                                               ',
    },
    {
    ...
    },
    {
      ...
      CONCEPTO:
        'Venta - Libros y Otras Formas de Comunicación                                                                                                                                                           ',
    },
    {
    ...
    },
    {
      ...
      CONCEPTO:
        'Venta Producto - Comedores                                                                                                                                                                              ',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.05.002.06.02            ',
      CONCEPTO:
        'Venta Producto - Cafetería                                                                                                                                                                              ',
    },
    {
    ...
    },
    {
      ...
      CONCEPTO:
        'Recobros UISALUD ARL                                                                                                                                                                              ',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.05.002.09.06            ',
      CONCEPTO:
        'Servicios Red Universitaria                                                                                                                                                                             ',
    },
    {
    ...
    },
    {
      ...
      CONCEPTO:
        'Nación - Funcionamiento                                                                                                                                                                      ',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.06.006.01.02            ',
      CONCEPTO:
        'Nacion Funcionamiento - Ajuste Ipc                                                                                                                                                                      ',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.06.006.01.03            ',
      CONCEPTO:
        'Nacion - Cesu (Art. 87 Ley 30 De 1992)                                                                                                                                                                  ',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.06.006.01.04            ',
      CONCEPTO:
        'Nacion Descuento Por Votaciones Ley 403 De 1997                                                                                                                                                         ',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.06.006.01.05            ',
      CONCEPTO:
        'Nacion Otros Aportes                                                                                                                                                                                    ',
    },
    {
    ...
    },
    {
      ...
      CONCEPTO:
        'Devolución IVA- Instituciones de Educación Superior                                                                                                                                                     ',
    },
    {
    ...
    },
    {
      ...
      CONCEPTO:
        'Departamento Regionalización - Funcionamiento                                                                                                                                                           ',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.06.006.06.01.04',
      CONCEPTO:
        'Departamento Regionalización - Inversión                                                                                                                                                         ',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.06.006.06.01.05',
      CONCEPTO:
        'Departamento  - Cesantías                                                                                                                                                                     ',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.06.006.06.01.06',
      CONCEPTO:
        'Gobierno Departamental - Ingresos Vigencias Anteriores                                                                                                                                                                           ',
    },
    {
    ...
    },
    {
      ...
      CONCEPTO:
        'Aporte UIS-Concurrencia Pasivo Pensional                                                            ',
    },
    {
    ...
    },
    {
      ...
      CONCEPTO:
        'Rendimientos Fondo Asegurador y Prestador                                                                                                                                                               ',
    },
    {
      RUBROPRESUPEUSTAL: '1.2.05.02.04',
      CONCEPTO:
        'Rendimientos Fondo Alto Costo y Promoción y Prevención                                                                                                                                                  ',
    },
    {
      RUBROPRESUPEUSTAL: '1.2.05.02.05',
      CONCEPTO:
        'Rendimientos Fondo Reserva Recursos UIS                                                                                                                                                         ',
    },
    {
      RUBROPRESUPEUSTAL: '1.2.05.02.06',
      CONCEPTO:
        'Rendimientos Fondo Reserva Recursos Propios                                                                                                                                                             ',
    },
    {
  ...
  equivalenciaINGRESO = [
    ...
    },
    {
      ...
      CONCEPTO:
        'Aporte Pos-Empleados UIS (3.3%) Fondo Asegurador (9701)                                                                                                                                                 ',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.01.001.01.01.02',
      CONCEPTO:
        'Aporte Pos-Empleados UIS (0.7%) Fondo Prestador (9702)                                                                                                                                                  ',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.01.001.01.02',
      CONCEPTO: 'Aportes empleador',
    },
    {
      ...
      CONCEPTO:
        'Aporte Pos-Empleador UIS (5.3%) Fondo Asegurador (9701)                                                                                                                                                 ',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.01.001.01.02.02         ',
      CONCEPTO:
        'Aporte Pos-Empleador UIS (1,2%) Fondo Prestador (9702)                                                                                                                                                  ',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.01.001.01.02.03         ',
      CONCEPTO:
        'Aporte Pos-Empleador UIS (0.5%)                                                                                                                                                                         ',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.01.001.01.03',
    ...
    },
    {
      ...
      CONCEPTO:
        'Plan Adicional-Afiliados (1.6%) Fondo Asegurador (9701)                                                                                                                                                 ',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.01.001.01.03.02         ',
      CONCEPTO:
        'Plan Adicional-Afiliados (0.4%) Fondo Prestador (9702)                                                                                                                                                  ',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.01.001.01.03.03         ',
      CONCEPTO:
        'Aporte Reserva Salud UIS(1%)                                                                                                                                                                           ',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.01.001.01.03.04         ',
      CONCEPTO:
        'Aporte Reserva Salud-Empleados Y Pensionados (0.5%)                                                                                                                                                     ',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.01.001.01.05',
      CONCEPTO: 'Aporte pensionados',
    },
    {
      ...
      CONCEPTO:
        'Aporte Pos-Pensionados UIS (8.6%) Fondo Asegurador (9701)                                                                                                                                               ',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.01.001.01.05.02         ',
      CONCEPTO:
        'Aporte Pos-Pensionados UIS (1.9%) Fondo Prestador (9702)                                                                                                                                                ',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.01.001.01.05.03         ',
      CONCEPTO:
        'Aporte Pos-Pensionados UIS (0.5%)                                                                                                                                                                        ',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.01.001.01.05.04         ',
      CONCEPTO:
        'Aporte Pos-Pensionados AFP (9%) Fondo Asegurador (9701)                                                                                                                                                 ',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.01.001.01.05.05         ',
      CONCEPTO:
        'Aporte Pos-Pensionados AFP (2%) Fondo Prestador (9702)                                                                                                                                                  ',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.02 ',
      CONCEPTO: 'Tasas y Derechos Administrativos',
    ...
    },
    {
      ...
      CONCEPTO:
        'Ingresos por Contribución en Venta Externa de Bienes y Servicios                                                                                                                                        ',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.05.002                  ',
      CONCEPTO:
    ...
    },
    {
      ...
      CONCEPTO:
        'Asignación para la ciencia, tecnología e innovación - convocatorias 2021',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.06.002.01.03.06.04',
      CONCEPTO:
        'Asignación para la ciencia, tecnología e innovación - convocatorias 2021 - ambiente y desarrollo sostenible',
    },
    {
      RUBROPRESUPEUSTAL: '1.1.02.06.006       ',
  ...
  corregirCodigos(): void {
    for (const userCode of this.datosTabla) {
      const matchingEquivalence = this.equivalenciaINGRESO.find(
        (equivalence: any) =>
          equivalence.RUBROPRESUPEUSTAL.trim() ===
          userCode.RUBROPRESUPEUSTAL.trim()
      );
    ...
    console.log('hola');
    // this.agregarEstructuraCodigo(this.datosTabla);
  }

  agregarEstructuraCodigo(objetos: any) {
    objetos.forEach((objeto: any) => {
      const codigoExistente = JSON.stringify(objeto.RUBROPRESUPEUSTAL).replace(
        /\./g,
        ''
      ); // Eliminar cualquier punto existente en el código
      ...
      objeto.RUBROPRESUPEUSTAL = codigoEstructurado;
    });
  ...
  separarPrimerGrupoCodigoConPunto(objetos: any[]) {
    const codigosSeparados = objetos.map((objeto) => {
      const codigo = objeto.RUBROPRESUPEUSTAL;
      ...
      if (partesCodigo.length >= 2) {
        ...
        return { ...objeto, RUBROPRESUPEUSTAL: nuevoCodigo };
      } else {
        return objeto;
      }
    });
  ...
  ejecutarResumenIngresos() {
    const busqueda = this.datosTabla.reduce((acc: any, codigo: any) => {
      acc[codigo.RUBROPRESUPEUSTAL.trim()] =
        ++acc[codigo.RUBROPRESUPEUSTAL.trim()] || 0;
      return acc;
    }, {});
    ...
    unicos.forEach((element: any) => {
      const arreglosSeparados = this.datosTabla.filter(
        (campo: any) => campo.RUBROPRESUPEUSTAL.trim() == element.trim()
      );
      ...
      for (let i = 0; i < element1; i++) {
        ...
        if (p == 0) {
          ...
          localStorage.setItem(
            element.RUBROPRESUPEUSTAL.trim(),
            JSON.stringify({
              codigo: element.RUBROPRESUPEUSTAL.trim(),
              recaudo: y,
              valor: x,
              definitivo: w,
              ejecutar: p,
    ...
    for (let index = 0; index < arraydeDuplicados.length; index++) {
      ...
      x.forEach((element: any) => {
        ...
        this.elementosUnificados = this.datosTabla.map((element1: any) =>
          element1.RUBROPRESUPEUSTAL.trim() == element.RUBROPRESUPEUSTAL.trim()
            ? element
            : element1
        );
      });
  ...
  ejecutarSegundoResumen() {
    for (let index = 0; index < this.informacion.length; index++) {
      const codigo = this.informacion[index].CODIGO;
      if (codigo) {
        let x = this.datosTabla.filter(
          (element: any) => element.RUBROPRESUPEUSTAL.trim() === codigo.trim()
        );
        if (x.length > 0) {
          x.forEach((element: any) => {
            // element.CPC = this.informacion[index].CPC
            element.TERCEROS = this.informacion[index].TERCEROS;
            element.FUENTESDEFINANCIACION =
              this.informacion[index].FUENTESDEFINANCIACION;
            element.POLITICAPUBLICA = this.informacion[index].POLITICAPUBLICA;
            this.elementosUnificados = this.datosTabla.map((element1: any) =>
              element1.RUBROPRESUPEUSTAL === element.RUBROPRESUPEUSTAL
                ? element
                : element1
            );
          });
  ...
  ejecutarModeloDeResumidos(contadorValor: any) {
    const busqueda = this.datosTabla.reduce((acc: any, codigo: any) => {
      acc[codigo.RUBROPRESUPEUSTAL.trim().slice(0, contadorValor)] =
        ++acc[codigo.RUBROPRESUPEUSTAL.trim().slice(0, contadorValor)] || 0;
      return acc;
    }, {});
    const duplicados = this.datosTabla.filter((codigo: any) => {
    ...
    let unicos: any = [];
    for (var i = 0; i < duplicados.length; i++) {
      const elemento = duplicados[i].RUBROPRESUPEUSTAL.trim().slice(
        0,
        contadorValor
      );
      if (
        !unicos.includes(
          duplicados[i].RUBROPRESUPEUSTAL.trim().slice(0, contadorValor)
        )
      ) {
        unicos.push(elemento);
    ...
    unicos.forEach((element: any) => {
      const arreglosSeparados = this.datosTabla.filter(
        (campo: any) =>
          campo.RUBROPRESUPEUSTAL.trim().slice(0, contadorValor) ==
          element.trim()
      );
      arreglosDuplicados.push(arreglosSeparados);
    });
    ...
    for (let index = 0; index < arreglosDuplicados.length; index++) {
      ...
      for (let i = 0; i < element1; i++) {
        ...
        if (p == 0) {
          ...
          localStorage.setItem(
            element.RUBROPRESUPEUSTAL.trim().slice(0, contadorValor),
            JSON.stringify({
              codigo: element.RUBROPRESUPEUSTAL.trim().slice(0, contadorValor),
              recaudoMODELO: y,
              valor: x,
              definitivo: w,
              ejecutar: p,
          ...
          if (element.POREJECUTAR == undefined || element.POREJECUTAR == null) {
            ...
            localStorage.setItem(
              element.RUBROPRESUPEUSTAL.trim().slice(0, contadorValor),
              JSON.stringify({
                codigo: element.RUBROPRESUPEUSTAL.trim().slice(
                  0,
                  contadorValor
                ),
                recaudoMODELO: y,
        ...
        if (w == 0) {
          ...
          if (
            element.PRESUPUESTODEFINITIVO == undefined ||
            element.PRESUPUESTODEFINITIVO == null
          ) {
            w = w + 0;
          } else {
            w = w + element.PRESUPUESTODEFINITIVO;
  ...
  extrayendoDuplicadosSumadosMODELO() {
    ...
    for (let index = 0; index < arraydeDuplicados.length; index++) {
      ...
      x.forEach((element: any) => {
        ...
        element.CPC = 0;
        if (
          element.RUBROPRESUPEUSTAL == '1.1.02.05.001.08' ||
          element.RUBROPRESUPEUSTAL == '1.1.02.05.001.09' ||
          element.RUBROPRESUPEUSTAL == '1.1.02.05.002.03' ||
          element.RUBROPRESUPEUSTAL == '1.1.02.06.006.06' ||
          element.RUBROPRESUPEUSTAL == '1.2.10.02' ||
          element.RUBROPRESUPEUSTAL == '1.2.05.02' ||
          element.RUBROPRESUPEUSTAL == '1.2.08.02' ||
    ...
    if (this.contadormodelo == 0) {
      this.modeloInformacion.forEach((element: any) => {
        ...
        this.datosTabla = this.datosTabla.filter(
          (element1: any) =>
            element1.RUBROPRESUPEUSTAL != element.RUBROPRESUPEUSTAL.trim()
        );
      });
  ...
  ejecutarREPORTEProgramacion(tipoReporte: any) {
    ...
    this.modeloParaReporteIngreso.forEach((element) => {
      let y = this.datosTabla.filter(
        (codigo: any) => codigo.RUBROPRESUPEUSTAL == element.CODIGO.trim()
      );
      x.push(y[0]);
    });
    this.datosTabla = x;
    ...
    for (let i = 0; i < this.datosTabla.length; i++) {
      ...
      if (
        this.datosTabla[i].RECAUDO != null &&
        this.datosTabla[i].RECAUDO != undefined
      ) {
        this.datosTabla[i].RECAUDO = parseFloat(
          this.datosTabla[i].RECAUDO.toFixed(2)
        );
      } else {
        this.datosTabla[i].RECAUDO = 0;
      }
